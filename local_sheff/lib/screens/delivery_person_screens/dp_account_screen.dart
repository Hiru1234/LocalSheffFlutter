...
class DpAccountScreen extends StatefulWidget {
  const DpAccountScreen({Key? key}) : super(key: key);

  @override
  State<DpAccountScreen> createState() => _DpAccountScreenState();
}

class _DpAccountScreenState extends State<DpAccountScreen> {
                  ...
                  children: [
                    reusableButton(context, 'Discard Changes', () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => DpAccountScreen()));
                    }, 170, 50),
                    const SizedBox(
                      width: 10,
                    ),
